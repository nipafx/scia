...
public class BasicUse {
	...
	private String runAll() throws InterruptedException {
	...
	private String computeAll() throws InterruptedException {
		var taskA = new Task("A");
		var taskB = new Task("B");
		var taskC = new Task("C");
	...
	private String threadDump() throws InterruptedException {
		var taskA = new Task("A");
		var taskB = new Task("B");
		var taskC = new Task("C");
	...
	private String observeErrors() throws InterruptedException {
		var taskA = new Task("A");
		var taskB = new Task("B");
		var taskC = new Task("C");
	...
	private String rollbackErrors() throws InterruptedException {
		var taskA = new Task("A");
		var taskB = new Task("B");
		var taskC = new Task("C");
	...
	private String rollbackLocally() throws InterruptedException {
		var taskA = new Task("A");
		var taskB = new Task("B");
		var taskC = new Task("C");
