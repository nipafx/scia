...
public class Joiners {
	...
	private String awaitAllSuccessfulOrThrow() throws InterruptedException {
	...
	private String allSuccessfulOrThrow() throws InterruptedException {
		var taskA = new Task("A");
		var taskB = new Task("B");
		var taskC = new Task("C");
	...
	private String anySuccessfulResultOrThrow() throws InterruptedException {
		var taskA = new Task("A");
		var taskB = new Task("B");
		var taskC = new Task("C");
		...
		try (var scope = StructuredTaskScope.open(Joiner.<String> anySuccessfulResultOrThrow())) {
			...
			try {
				return "JOINER RESULT: " + scope.join();
			} catch (StructuredTaskScope.FailedException ex) {
				return formatStates(taskA, taskB, taskC);
			}
		}
	...
	private String awaitAll() throws InterruptedException {
		var taskA = new Task("A");
		var taskB = new Task("B");
		var taskC = new Task("C");
	...
	private String allUntil() throws InterruptedException {
		var taskA = new Task("A");
		var taskB = new Task("B");
		var taskC = new Task("C");
